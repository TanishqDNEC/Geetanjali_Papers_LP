    ...
    <main className="bg-white text-gray-800 px-6 md:px-16 py-16">
      ...
      <section className="mb-16">
        <div className="bg-slate-100 rounded-xl p-8 shadow-lg">
          <h2 className="text-2xl font-bold mb-2 text-slate-800">Owner</h2>
      ...
      {/* Clients Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold mb-4 text-slate-800">Clients</h2>
      ...
      {/* Location Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold mb-4 text-slate-800">Location</h2>
        <p className="text-gray-700 text-lg">
          📍 <strong>Varanasi, Uttar Pradesh</strong>
        </p>
        <p className="text-gray-500">123, Industrial Layout, Near Print Bazaar, Varanasi, UP - 221001</p>
      </section>

      {/* Quotes Section */}
      <section className="text-center mt-20">
        <blockquote className="italic text-xl font-medium text-gray-800 mb-6">
        "Success in business comes not from luck, but from relentless effort, sleepless nights, and the courage to keep going when others quit."        </blockquote>
